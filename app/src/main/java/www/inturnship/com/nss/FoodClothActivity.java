...
public class FoodClothActivity extends AppCompatActivity {
    TextView header;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_cloth);
        ...
        header.setText("Food And Clothes Distribution");
        back=findViewById(R.id.img_nav);
        back.setImageResource(R.drawable.img_arrowleft);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(FoodClothActivity.this,HomeActivity.class);
