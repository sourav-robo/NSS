...
public class SchoolHopeActivity extends AppCompatActivity {
    TextView header;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_hope);
        ...
        header.setText("School Of Hope");
        back=findViewById(R.id.img_nav);
        back.setImageResource(R.drawable.img_arrowleft);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SchoolHopeActivity.this,AashaActivity.class);
