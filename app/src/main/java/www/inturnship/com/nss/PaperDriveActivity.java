...
public class PaperDriveActivity extends AppCompatActivity {
    TextView header;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paper_drive);
        ...
        header.setText("Paper Drive");
        back=findViewById(R.id.img_nav);
        back.setImageResource(R.drawable.img_arrowleft);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(PaperDriveActivity.this,HomeActivity.class);
