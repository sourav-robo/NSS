...
public class QuizotikaActivity extends AppCompatActivity {
    TextView header;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizotika);
        ...
        header.setText("Quizotika");
        back=findViewById(R.id.img_nav);
        back.setImageResource(R.drawable.img_arrowleft);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(QuizotikaActivity.this,AashaActivity.class);
